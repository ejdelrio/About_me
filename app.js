'use strict';
// intentional inifinite loop. Linter error unavoidable.
while (true){

  var iphone = prompt('Congratulations!! You just won a free Iphone 8! Would you like to claim it? \n (Enter Y or N)').toUpperCase();
  console.log('user input: ', iphone);
  if (iphone === 'Y' || iphone === 'YES') {
    prompt('Awesome!!! I just need you to enter your email address and credit card info :D');
    break;
...
console.log('user input: ', bahamas);
if(bahamas === 'YES' || bahamas === 'Y') {
  prompt('Fantastic. We just need the passengers info to book the tickets. Please enter your DOB, social security and address below. :)');
